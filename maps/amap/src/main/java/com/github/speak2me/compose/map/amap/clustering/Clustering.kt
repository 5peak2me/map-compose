...
import com.github.speak2me.compose.map.amap.rememberComposeUiViewRenderer
import com.github.speak2me.compose.map.amap.rememberReattachClickListenersHandle
...
//        onInfoWindowLongClick = clusterManager.markerManager::onInfoWindowLongClick,
    ...
    LaunchedEffect(cameraPositionState) {
        snapshotFlow { cameraPositionState.isMoving }
            .collect { isMoving ->
                if (!isMoving) {
                    clusterManager.onCameraChangeFinish(null)
                }
            }
    }
