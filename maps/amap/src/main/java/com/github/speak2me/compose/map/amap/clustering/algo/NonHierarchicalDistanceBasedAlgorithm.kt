...
import com.github.speak2me.compose.map.amap.clustering.android.quadtree.PointQuadTree
...
public open class NonHierarchicalDistanceBasedAlgorithm<T : ClusterItem> : AbstractAlgorithm<T>() {
    ...
    protected val mItemMap: HashMap<T, QuadItem<T>> = HashMap<T, QuadItem<T>>()
    ...
    public class QuadItem<T : ClusterItem>(
