...
public typealias HuaweiMapFactory = @Composable () -> Unit

/**
 * This method provides a factory pattern for HuaweiMap. It can typically be used in tests to provide a default Composable
 * of type HuaweiMapFactory.
 *
...
public enum class ComposeMapColorScheme(public val value: Int) {
    LIGHT(HuaweiMap.MAP_TYPE_NORMAL),
    DARK(HuaweiMap.MAP_TYPE_HYBRID),
}
