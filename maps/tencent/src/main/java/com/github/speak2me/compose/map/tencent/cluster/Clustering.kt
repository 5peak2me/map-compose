...
import com.github.speak2me.compose.map.tencent.TencentMapComposable
import com.github.speak2me.compose.map.tencent.currentCameraPositionState
import com.github.speak2me.compose.map.tencent.rememberComposeUiViewRenderer
import com.github.speak2me.compose.map.tencent.rememberReattachClickListenersHandle
...
//        onInfoWindowLongClick = clusterManager.markerManager::onInfoWindowLongClick,
    ...
    LaunchedEffect(cameraPositionState) {
        snapshotFlow { cameraPositionState.isMoving }
            .collect { isMoving ->
                if (!isMoving) {
                    clusterManager.onCameraChangeFinished(cameraPositionState.position.toSdkPosition())
                }
            }
    }
 ...
 * overwrites a bunch of [TencentMap]'s listeners. Many Maps composables rely on those listeners
 * being set by [com.github.speak2me.compose.map.tencent.MapApplier].
