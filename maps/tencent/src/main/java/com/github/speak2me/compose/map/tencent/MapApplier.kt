...
// [TencentMap.setOnIndoorStateChangeListener()] will not actually set a new non-null listener if
...
//            )
//        }
        map.setOnPolygonClickListener { polygon, location ->
        ...
        map.setOnPolylineClickListener { polyline, location ->
