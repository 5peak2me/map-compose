...
public enum class CameraMoveStartedReason(public val value: Int) {
    UNKNOWN(-2),
    NO_MOVEMENT_YET(-1),
    GESTURE(CameraPosition.Trigger.GESTURE.ordinal),
    API_ANIMATION(CameraPosition.Trigger.API.ordinal),
    DEVELOPER_ANIMATION(CameraPosition.Trigger.ANIMATION.ordinal);

    public companion object {
        /**
         * Converts from the Maps SDK [com.tencent.tencentmap.mapsdk.maps.TencentMap.OnCameraChangeListener]
