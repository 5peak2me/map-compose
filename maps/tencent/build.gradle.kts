...
android {
    namespace = "com.github.speak2me.lib.compose.map.tencent"
...
//    implementation(libs.androidx.ui.tooling.preview)
    ...
    api(libs.map.tencent)
    // 基础库
    api(libs.map.tencent.foundation)
    // 地图组件库，包括小车平移、点聚合等组件功能，详见开发指南。
    api(libs.map.tencent.utilities)
    api(libs.map.tencent.geolocation)
