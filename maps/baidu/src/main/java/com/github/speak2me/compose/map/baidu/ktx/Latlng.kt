...
public operator fun LatLng.minus(distanceOf: LatLng): Double =
    DistanceUtil.getDistance(this, distanceOf)
 ...
 */
public inline fun List<LatLng>.sphericalPolygonArea(): Double = AreaUtil.calculateArea(this)
...
public inline fun LatLng.sphericalDistance(to: LatLng): Double =
    DistanceUtil.getDistance(this, to)
